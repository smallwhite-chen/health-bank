  ...
  lipidItems: [
    {
      ...
      education: {
        ref: "<200 mg/dl",
        body: "總膽固醇值過高可能有動脈硬化風險，通常要再檢查高密度脂蛋白「好」膽固醇與低密度脂蛋白「壞」膽固醇的濃度。如果總膽固醇值高，建議應至院所就醫，與你的醫師討論。",
    ...
    },
    {
      ...
      education: {
        ref: "<150 mg/dl",
        body: "三酸甘油酯是血脂肪的一種，又稱「中性脂肪」。三酸甘油酯過高者常伴隨膽固醇過高，或有較高風險罹患急性胰臟炎，建議應至院所就醫，與你的醫師討論。",
        resources: ["台灣血脂衛教協會", "中華民國血脂及動脈硬化學會", "心肌梗塞學會｜TAMIS"],
      },
    },
    {
      ...
      education: {
        ref: ">50 mg/dl",
        body: "高密度脂蛋白就是俗稱「好」膽固醇，本項數值若偏低，血管動脈粥狀硬化風險提高，建議應至院所就醫，與你的醫師討論。",
        resources: ["台灣血脂衛教協會", "中華民國血脂及動脈硬化學會", "心肌梗塞學會｜TAMIS"],
      },
    },
    {
      ...
      education: {
        ref: "<130 mg/dl",
        body: "低密度脂蛋白就是俗稱「壞」膽固醇，本項數值若偏高，血管動脈粥狀硬化風險提高，建議應至院所就醫，與你的醫師討論。",
        resources: ["台灣血脂衛教協會", "中華民國血脂及動脈硬化學會", "心肌梗塞學會｜TAMIS"],
      },
    },
  ],
