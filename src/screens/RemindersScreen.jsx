...
function RemindersScreen({ navigate }) {
  ...
  const items = [
    { type:"用藥提醒", date:"115年4月15日", body:"你的慢性處方箋藥物「降血壓藥 Amlodipine 5mg」將於 115年4月20日 用完，請記得於到期前至藥局領藥或回診取得新處方。" },
    { type:"個人化", date:"115年4月12日", body:"根據你的健檢紀錄，你的空腹血糖值偏高（108 mg/dL），建議你近期安排回診追蹤，並留意飲食與運動習慣。" },
    { type:"用藥提醒", date:"115年4月10日", body:"提醒你今日應服用「Metformin 500mg」餐後一顆，請依照醫囑按時用藥，如有不適請聯繫你的家庭醫師。" },
    { type:"個人化", date:"115年4月8日",  body:"你距離上次洗牙已超過 5 個月，建議於 115年6月15日 前安排洗牙，維護口腔健康。" },
    { type:"用藥提醒", date:"115年4月5日",  body:"你的「降血脂藥 Rosuvastatin 10mg」處方已過期，請儘速回診由醫師評估是否續用。" },
    { type:"個人化", date:"115年3月28日", body:"你本月步數累積已達 85,000 步，距離健康目標 100,000 步還差 15,000 步，加油！" },
  ];
